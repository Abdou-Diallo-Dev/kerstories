    ...
    const scenesHtml = scenes.map((scene, i) => `
      <div class="scene-page">
        <div class="scene-header">
          <span class="scene-num">Scène ${scene.num}</span>
          <h2 class="scene-title">${scene.titre}</h2>
        </div>
        ${scene.svgIllustration ? `
          <div class="illustration">
            ${scene.svgIllustration.replace('viewBox="0 0 800 500"', 'viewBox="0 0 800 500" width="100%" height="auto"')}
          </div>
...
<body>
  <!-- Couverture -->
  <div class="cover">
    <div class="cover-tag">KërStories · ${meta.pays}</div>
  ...
  <div class="morale-page">
    ...
    <p class="morale-brand">Créé avec KërStories · kerstories.app</p>
  </div>
</body>
</html>`;
